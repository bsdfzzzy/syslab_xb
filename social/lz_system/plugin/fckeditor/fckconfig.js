...
_url = _url.split('lz_system/');
FCKConfig.BaseHref = _url[0];
...
FCKConfig.FontSizes		= '9px;10px;12px;13px;14px;16px;18px;20px;25px;32px;45px;64px;';//'smaller;larger;xx-small;x-small;small;medium;large;x-large;xx-large' ;
